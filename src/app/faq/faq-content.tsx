              ...
              <div className="page-enter page-enter-d1 space-y-4">
                {copy.items.map((faq, index) => (
                  ...
                  >
                    ...
                    <CollapsibleContent className="border-t border-[var(--line)]/60 px-6 pb-5 text-sm [&[data-state=open]_[data-faq-body]]:animate-[faq-body-in_360ms_cubic-bezier(0.22,1,0.36,1)] [&[data-state=closed]_[data-faq-body]]:animate-[faq-body-out_220ms_cubic-bezier(0.4,0,1,1)]">
                      <p data-faq-body className="pt-3 leading-relaxed text-[var(--ink)]/72">
                        {faq.answer}
                      </p>
                    </CollapsibleContent>
                  </Collapsible>
